...
public class TestBlockRecovery {
  ...
  public void testRecoveryWillIgnoreMinReplication() throws Exception {
    ...
    try {
      ...
      // Prevent automatic lease recovery and trigger it manually
      cluster.setLeasePeriod(Long.MAX_VALUE, Long.MAX_VALUE);
      dfsClient.getNamenode().recoverLease("/testIgnoreMinReplication", "client");
